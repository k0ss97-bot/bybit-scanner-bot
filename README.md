...
При `DUMP_CHART_ENABLED=true` вслед за текстом сигнала приходит PNG-график: 15-минутные свечи Binance за 48 часов, объем, OI, CVD, high разгона, точка сигнала, отмена сценария и цели 1R/2R.
